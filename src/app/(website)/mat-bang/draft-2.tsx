...
const Page = () => {
  return (
    <div>
      <section className="relative h-[400px] md:h-[500px]">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center p-4 text-center text-white">
          <h1 className="font-playfair mb-4 text-4xl font-bold md:text-5xl">
            Mặt bằng & <span className="text-green-400">Sản phẩm</span>
          </h1>
        ...
        <div className="container mx-auto px-4">
          <div className="mx-auto mb-12 max-w-3xl text-center">
            <h2 className="font-playfair mb-4 text-3xl font-bold text-gray-900 md:text-4xl">
              Mặt bằng <span className="text-green-700">tổng thể</span>
            </h2>
            ...
            <div className="rounded-xl border border-gray-100 bg-white p-6 shadow-sm transition-shadow hover:shadow-md">
              ...
              <ul className="mb-6 space-y-2">
                <li className="flex items-start">
                  <Check className="mr-2 mt-1 h-5 w-5 text-green-600" />
      ...
      {/* Sản phẩm */}
      <section id="biet-thu" className="bg-gray-50 py-16 md:py-24">
        <div className="container mx-auto px-4">
          <div className="mx-auto mb-12 max-w-3xl text-center">
            <h2 className="font-playfair mb-4 text-3xl font-bold text-gray-900 md:text-4xl">
          ...
          <Tabs defaultValue="biet-thu" className="w-full">
            <TabsList className="mb-8 grid w-full grid-cols-3">
              <TabsTrigger value="biet-thu">Biệt thự</TabsTrigger>
              <TabsTrigger value="nha-pho" id="nha-pho">
                Nhà phố
              </TabsTrigger>
              <TabsTrigger value="thuong-mai" id="thuong-mai">
                Shophouse
              </TabsTrigger>
            </TabsList>
                  ...
                  <div>
                    ...
                    <div className="mb-6 space-y-3">
                      <div className="flex items-start">
                        <Check className="mr-3 mt-1 h-5 w-5 text-green-600" />
                        <div>
          ...
          <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
            <div>
              <h2 className="font-playfair mb-6 text-3xl font-bold text-gray-900 md:text-4xl">
                Đăng ký <span className="text-green-700">nhận thông tin</span>
              </h2>
              ...
              <div className="mb-8 rounded-xl bg-green-50 p-6">
                <div className="mb-4 flex items-center">
                  <ArrowRight className="mr-3 h-6 w-6 text-green-700" />
              ...
              <div className="flex items-center">
                <div className="mr-6">
                  <p className="text-lg font-semibold text-gray-900">Hotline</p>
                ...
                <div>
                  ...
                  <p className="text-green-700">info@economycity.com.vn</p>
                </div>
              </div>
            </div>
          </div>
